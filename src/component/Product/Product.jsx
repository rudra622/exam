...
import { getProductAsync, getProductsAsync } from '../../services/Action/ProductAction'
    ...
    return (
        <>
            <div className="container">
                <h1 className='text-center m-5'>Our Product</h1>
                <div className="row">
                    {
                        Products.map((pro) => {
                            return (
                                    ...
                                    <div className="box-main">
                                        ...
                                        <div className='btn-main d-flex pb-3 justify-content-between'>
                                            <div className='buy-bt align-items-center text-white  bg-danger p-2 rounded'>
                                                <Cart />
                                                <a href="" className='text-decoration-none text-white' onClick={()=>{handleClick(pro.id)}}> buy now</a>
                                            </div>
